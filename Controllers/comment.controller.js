...
const postComment = async(req, res) => {
  ...
  const regex = /\b(?:Fuck you|mad|foolish|liar|thief|fool|stupid|bad|don't care|werey|stupid|crazy|bitch|ass|pussy|dick|lies|swear|nigger|nigga|asshole|ass|bum bum|shut up|get out|nigger|nyash|fuck|arse|ass|Bitchass|sematic|Bonzo|waka|shege|banza|ubanka|werey|olodo)\b/i;
