...
const openai = new OpenAIAPI({ apiKey: password } );
...
const postComment = async(req, res) => {
  ...
  const regex = /\b(?:Fuck you|mad|foolish|liar|thief|fool|stupid|bad|don't care|werey|stupid|crazy|bitch|ass|pussy|dick|lies|swear|nigger|nigga|asshole|ass|bum bum|shut up|get out|)\b/i;
